import whatzonIcon from "./images/whatzon.png";
import lhiIcon from "./images/lhi.png";
...
import sckIcon from "./images/sck.svg";
...
export default function Projects() {
  return (
    <div className="rounded-lg border-2 bg-gray-200 divide-y sm:divide-y-0 sm:grid sm:gap-px">
      {actions.map((action, actionIdx) => (
        ...
        >
          ...
          <div className="relative flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
            <div className="flex-shrink-0">
              <img className="h-20 w-20" src={action.icon} alt="" />
            </div>
          ...
          <div className="mt-8">
            <h3 className="text-lg font-medium">
              <a className="focus:outline-none">
                {/* Extend touch target to entire panel */}
                <span className="absolute inset-0" aria-hidden="true" />
                {"Tech Implemented By Me"}
              </a>
            </h3>
            <div style={{ width: "100%", height: "100%" }}>
              {action?.techIcon?.map((data) => (
                <a href={data.link} target="_blank">
                  <img
                    className="m-3 inline-block relative"
                    src={data.icon}
                    style={{
                      height: data.isOther ? "25px" : "50px",
                      width: data.isOther ? "100px" : "50px",
                    }}
                  />
                </a>
              ))}
